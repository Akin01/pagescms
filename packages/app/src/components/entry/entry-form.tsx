...
import { editComponents } from "@pagescms/core/fields";
import {
  initializeState,
  getDefaultValue,
  generateZodSchema,
...
import { Field } from "@pagescms/core/types/field";
...
import { interpolate } from "@pagescms/core/lib/schema";
...
const EntryForm = ({
  ...
  const form = useForm({
    resolver: zodSchema && zodResolver(zodSchema as unknown as Parameters<typeof zodResolver>[0]),
    defaultValues,
